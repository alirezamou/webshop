<template>
    <section class="section container">
        ...
        <a @click="addingProduct = true" class="button is-primary">
            <fa-icon icon="fa-solid fa-plus"></fa-icon> Add Product
        </a>
                ...
                <table class="table is-narrow">
                    ...
                    <tbody>
                        <tr v-for="(size, sizeIndex) in product.data.sizes" :key="sizeIndex">
                            ...
                            <td><a @click="delete_size(index, sizeIndex)" class="button is-danger">
                                <fa-icon icon="fa-solid fa-times"></fa-icon>
                            </a></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="input" v-model="newSize.price"></td>
                            <td><button type="submit" class="button is-success">
